 ...
 * Generated for Laravel 5.6.35 on 2018-09-01 20:20:06.
 *
...
namespace Illuminate\Support\Facades { 
    ...
    class Route {
         ...
         * @static 
         */ 
        public static function localizedGroup($callback, $attributes = array())
        {
            return \Illuminate\Routing\Router::localizedGroup($callback, $attributes);
        }
         ...
         * @static 
         */ 
        public static function transGet($trans, $action)
        {
            return \Illuminate\Routing\Router::transGet($trans, $action);
        }
         ...
         * @static 
         */ 
        public static function transPost($trans, $action)
        {
            return \Illuminate\Routing\Router::transPost($trans, $action);
        }
         ...
         * @static 
         */ 
        public static function transPut($trans, $action)
        {
            return \Illuminate\Routing\Router::transPut($trans, $action);
        }
         ...
         * @static 
         */ 
        public static function transPatch($trans, $action)
        {
            return \Illuminate\Routing\Router::transPatch($trans, $action);
        }
         ...
         * @static 
         */ 
        public static function transDelete($trans, $action)
        {
            return \Illuminate\Routing\Router::transDelete($trans, $action);
        }
         ...
         * @static 
         */ 
        public static function transOptions($trans, $action)
        {
            return \Illuminate\Routing\Router::transOptions($trans, $action);
        }
         ...
         * @static 
         */ 
        public static function transAny($trans, $action)
        {
            return \Illuminate\Routing\Router::transAny($trans, $action);
        }
